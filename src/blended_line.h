#ifndef BLENDED_LINE_H

#define BLENDED_LINE_H

/**
 * Draws a blended line.
 ...
 *                    negative infinity or unable to be cast to int.
 * @param end_opacity The opacity at the end of the line, where 0 is fully
 *                    transparent and 1 is fully opaque.  Behavior is undefined
 *                    for values outside this range, NaN, infinity or positive
 *                    infinity.
